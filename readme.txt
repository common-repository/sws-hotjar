...
1. Use the *Tools > Hotjar for WordPress* page to add your Hotjar SiteID for the tracking code.
...
No, this plugin has been developed by [Stoute.co](https://stoute.co/ "Your Marketing Partner") for use on their client sites. This plugin has been made publicly available to anyone who uses the Hotjar heatmaps to make the process easier and pain free.
